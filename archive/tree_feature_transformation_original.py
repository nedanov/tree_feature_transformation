...
class TreeTransformClf(object):
	...
	subparameters: pass those directly into the classification method
		n_estimators: number of trees to build (default is 10)
	...
	def __init__(self,tree_clf=RandomForestClassifier()):
		...
		self.logit_clf = LogisticRegression()
	...
	def fit(self,X,y,split_size=0.5):
		...
		X1,X2,y1,y2 = train_test_split(X,y,test_size=split_size,random_state=0)
